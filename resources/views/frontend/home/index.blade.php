...
@endif
  ...
  <!--<div class="simple-adv11 item-adv-simple">
    <a href="#"><img src="{{ URL::asset('public/assets/images/ad1.jpg') }}" alt="" /></a>
  </div>-->
  @endforeach
  
  <!-- End Adv -->
  <!--<div class="list-partner list-partner11 clearfix">
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn1.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn2.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn3.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn4.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn5.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn6.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn7.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn8.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn9.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn10.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn11.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn12.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn13.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn14.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn15.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn16.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn17.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn18.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn19.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn20.png') }}"></a>
    <a class="partner-link" href="#"><img alt="" src="{{ URL::asset('public/assets/images/pn21.png') }}"></a>
  </div>-->
  <!-- End Partner -->
</div>
@endsection