                      ...
                      <div class="panel-body">
                        <form class="form-horizontal bv-form" role="form" id="address-info" novalidate>
                          ...
                          <div class="form-group row form-group-radio group-radio-k-address">
                            ...
                            <div class="col-lg-8 input-wrap"> <span style="font-size: 11px;font-style: italic;">Để nhận hàng thuận tiện hơn, bạn vui lòng cho shop.com biết loại địa chỉ.</span> </div>
                          </div>
