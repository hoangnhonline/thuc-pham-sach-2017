									...
									<li class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
										<div class="item-product">
											<div class="product-thumb">
												...
												<div class="product-info-cart">									 <a class="{{ $product->het_hang == 1 ? "het-hang" : 'addcart-link' }}" href="javascript:void(0)" data-id="{{ $product->id }}">@if($product->het_hang == 0) <i class="fa fa-shopping-basket"></i>@endif {{ $product->het_hang == 1 ? "Tạm hết hàng" : trans('text.mua-hang') }}</a>
												</div>
												@endif
											</div>
