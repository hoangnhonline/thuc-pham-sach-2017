                  ...
                  <tbody>
                    <tr>
                      ...
                      <h1 style="font-size:17px;font-weight:bold;color:#444;padding:0 0 5px 0;margin:0"> Cảm ơn
                          ...
                          đã đặt hàng tại <strong>tps.net.vn</strong>,</h1>
                     
                        <p style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal"> <strong>tps.net.vn</strong> rất vui thông báo đơn hàng #{{ $order_id }} của quý khách đã
                          được tiếp nhận và đang trong quá trình xử lý. <strong>tps.net.vn</strong> sẽ thông báo đến quý khách
                      ...
                      <td style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px"><table cellspacing="0" cellpadding="0" border="0" width="100%">
                          ...
                          <tbody>
                            ...
                            <?php if($method_id == 2) {
                              ...
                              echo "Giao hàng và thu tiền tận nhà ( COD )";
                            }
