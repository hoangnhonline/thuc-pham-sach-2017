          ...
          <!-- /.box-header -->               
            ...
            <div class="box-body">
              ...
              @endif
                ...
                <div class="form-group">
                  <label>Email nhận thông báo ( các mail cách nhau dấu , )</label>
                  <input type="text" class="form-control" name="email_nhan_thong_bao" id="email_nhan_thong_bao" value="{{ $settingArr['email_nhan_thong_bao'] }}">
                </div>
                <div class="form-group">
